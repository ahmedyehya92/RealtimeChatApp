package com.example.ahmedyehya.realtimechatapp;
...
import com.example.ahmedyehya.realtimechatapp.utils.EndPoints;
import com.example.ahmedyehya.realtimechatapp.utils.MyVolley;
...
public class SendPushNotificationActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
                        ...
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(
                                        SendPushNotificationActivity.this,
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, EndPoints.URL_SEND_MULTIPLE_PUSH,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(SendPushNotificationActivity.this, response, Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
